    ...
    <ThemeProvider theme={theme}>
      ...
      <StyledContainer>
        ...
        <Typography variant="body1" paragraph fontFamily="Hahmlet">
          Hahmlet 이것은 {`body1`} 텍스트입니다. {`"검은 별 아래에서"`}의 세계는
          어둡고 불가해한 공포로 가득 차 있습니다. 플레이어는 살아남기 위해,
          혹은 진실을 찾기 위해 이성을 대가로 위험한 선택을 해야 할 것입니다.
          이곳의 텍스트는 {`theme.palette.text.primary`} 색상을 따릅니다.
        </Typography>
        <Typography variant="body2" fontFamily="Hahmlet" paragraph>
          Hahmlet 이것은 {`body2`} 텍스트입니다. 부가적인 설명이나 덜 중요한
          정보에 사용됩니다. {`theme.palette.text.secondary`} 색상으로
          표시됩니다.{' '}
        ...
        <Section elevation={1}>
          <Typography variant="h5" gutterBottom>
            페이퍼 (Paper) & 툴팁 (Tooltip)
          </Typography>
          <Paper sx={{ padding: 2, mt: 2, display: 'inline-block' }}>
            <Typography variant="body1">
              이것은 Paper 컴포넌트 내부의 텍스트입니다.
            </Typography>
            <Typography variant="body2" sx={{ mb: 2 }}>
              어두운 테마에 맞춰 배경색과 테두리가 적용되었습니다.
            </Typography>
        ...
        <Section>
          ...
          <Stack sx={{ width: '100%', mt: 2 }} spacing={2}>
            ...
            <Alert severity="success">
              ...
              이것은 성공(success) 알림입니다 —{' '}
              <strong>잘 처리되었습니다!</strong>
            </Alert>
          </Stack>
        </Section>
        ...
        <Box sx={{ mt: 4 }}>
          <Typography variant="caption" display="block" gutterBottom>
            * 버튼 클릭 시 리플 효과는 테마에서 {`disableRipple: true`}로 전역
            비활성화 되었습니다.
          </Typography>
          <Typography variant="caption" display="block">
            * 버튼 클릭 후 포커스 상태에서도 원래 색상으로 돌아오도록 테마가
            설정되었습니다.
          </Typography>
        </Box>
      </StyledContainer>
